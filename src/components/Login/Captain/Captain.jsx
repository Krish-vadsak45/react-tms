...
export default function CaptainLogin() {
  ...
  return (
    <div className="flex justify-center bg-[url('./src/assets/taxi-image.png')] bg-cover bg-center bg-repeat h-screen w-full">
      <form className="flex flex-col gap-4 bg-white p-8 w-96 rounded-2xl shadow-md m-32">
        <div className="flex flex-col">
          <h2 className="text-center text-2xl font-semibold text-gray-800">
            Captain Login
          </h2>
          <span class="m-0 text-[0.85rem] py-3 max-w-[90%] text-center text-gray-950">
